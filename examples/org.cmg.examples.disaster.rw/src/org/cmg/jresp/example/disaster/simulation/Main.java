...
import org.cmg.jresp.examples.disaster.ProgressiveDiscovery;
...
import org.cmg.jresp.examples.disaster.SpreadOverNest;
...
public class Main extends JFrame {
	...
	for (int i=0 ;i<scenario.getLandmarks();i++) {
			...
			n.addAgent(a);
			a = new ProgressiveDiscovery(i, scenario);
			n.addAgent(a);
			a = new SpreadOverNest(i, scenario);
			n.addAgent(a);
