...
public class Chapter_3_ProducerConsumerSpaces {

	public static void main(String[] argv) {
		
		// Here we can choose different bags of tasks
		KnowledgeManager Bag = new TupleSpace();
		//KnowledgeManager Bag = new RandomSpace();
		//KnowledgeManager Bag = new FIFOSpace();
		//KnowledgeManager Bag = new StackSpace();

		// We create a node for the appartment
		Node Appartment = new Node("Appartment", Bag);
