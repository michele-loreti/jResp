 ...
 */
package org.cmg.jresp.knowledge.ts.fifo;
 ...
 * get/query consider the oldest inserted tuple/message only
 * getAll provides the longest suffix of tuples that matches the pattern 
 * 
 * @author Alberto Lluch Lafuente
 *
 */
public class FIFOSpace implements KnowledgeManager {
