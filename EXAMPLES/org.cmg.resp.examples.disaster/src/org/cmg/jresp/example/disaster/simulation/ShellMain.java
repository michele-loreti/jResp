...
public class ShellMain {
	...
	public static void main(String[] argv) throws InterruptedException, FileNotFoundException {
		...
		// ShellMain main = new ShellMain( numLandmarks , numWorkers , HEIGHT ,
		// WIDTH );
		// double dt = 10.0;
		// double deadline = 5000;
		// int iterations = 100;
		// HashMap<Double, Integer> results = main.modelCheck(iterations,
		// deadline , dt );
		// double count = 0.0;
	...
	public static void modelCheck(int numLandmarks, int numWorkers, double deadline, double dt, int iterations)
		...
		PrintWriter writer = new PrintWriter(
				"/Users/loreti/Desktop/DISASTER_DATA/data_" + numLandmarks + "_" + numWorkers + ".dat");
		double count = 0.0;
		while (count <= deadline) {
			Integer value = results.get(count);
			double prob = 0.0;
