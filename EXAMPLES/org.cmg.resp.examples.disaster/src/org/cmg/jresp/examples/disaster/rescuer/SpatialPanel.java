...
public class SpatialPanel extends JPanel implements Observer {
	...
	public void paint(Graphics arg0) {
		...
		/*
		 * //Re-charging Station (only one) Point2D.Double charge_station =
		 * scenario.getChargingStationPosition();
		 * g2.setColor(scenario.getColorChargingStation()); g2.fill(new
		 * Ellipse2D.Double(charge_station.x-20,charge_station.y-20, 60, 20));
		 */
